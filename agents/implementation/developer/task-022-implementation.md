...
## Selected Task
- Code: `TASK-022`
- File: `agents/backlog/tasks/TASK-022-developer-schould-commit-and-push-after.md`
- Goal: developer schould commit and push after he finishes his task, then the reviewer should check his commit

## Implementation Objective
Translate the latest analyst findings into concrete implementation work aligned with this goal: developer schould commit and push after he finishes his task, then the reviewer should check his commit

## Exact Files Likely To Change
- `agents/backlog/tasks/TASK-022-developer-schould-commit-and-push-after.md`
...
- Keep changes scoped to the selected task `agents/backlog/tasks/TASK-022-developer-schould-commit-and-push-after.md`.
...
1. Review `agents/backlog/tasks/TASK-022-developer-schould-commit-and-push-after.md` and confirm the task is still in scope.
2. Update `agents/backlog/tasks/TASK-022-developer-schould-commit-and-push-after.md` status from `todo` to `in-progress` before making changes.
3. Apply the required repository changes in `docs/human-approval-checklists.md`, `docs/target-repo-onboarding.md`, `prompts/agents/developer.md`, `AGENTS.md`.
4. Run the smallest relevant verification commands for the changed files.
5. Update `agents/backlog/tasks/TASK-022-developer-schould-commit-and-push-after.md` to `done` only after the acceptance criteria are met.
...
Goal: developer schould commit and push after he finishes his task, then the reviewer should check his commit
Selected task file: `agents/backlog/tasks/TASK-022-developer-schould-commit-and-push-after.md`
...
```md
# TASK-022 Planner Follow-up: developer schould commit and push after he finishes his task, then the reviewer should check his commit

...
Write analysis to `agents/<target-name>/analysis/repo-analysis.md` and format the response with the handoff contract sections:
...
## Artifacts
- agents/<target-name>/analysis/repo-analysis.md: Structured repository analysis for planning.
